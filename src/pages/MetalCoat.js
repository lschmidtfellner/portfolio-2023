...
function MetalCoat({ pColor, handleNavigation }) {
  ...
  return (
    <div style={{ color: pColor }} className="mx-6 mt-20 w-auto ">
      ...
      I began making apparel in the esports community in 2018 with the mission of creating extremely subtle yet aesthetically appealing clothing for people in the scene. I traveled to large scale tournaments and conventions, networking with influencers and selling my merchandise in person before slowly developing the skills to build and manage an ecommerce platform.
      </p>
